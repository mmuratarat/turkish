...
Dış değişiklikler daha ani veya şiddetli olabilir. Bunları gözden kaçırmak oldukça zordur. Yukarıda verdiğimiz gibi, bu duruma en mükemmel örnek COVID-19 salgınıdır. Bu salgın, neredeyse bir gecede, evde-kal politikası sebebiyle tüm hareketlilik ve alışveriş kalıplarını değiştirmiştir. Her türlü model bu durumdan etkilenmiştir. En "kararlı" modeller bile. Talep tahmin modelleri, yoga pantolonu satışlarının %350 artacağını ([Stitch Fix'te olduğu gibi](https://fortune.com/2020/09/23/a-i-algorithms-had-to-change-when-covid-19-changed-consumer-behavior/)) veya sınırlar kapanırken çoğu uçuşun iptal edileceğini tahmin edememiştir. Bu durum sadece finansal modelleri değil, aynı zamanda sağlık sektöründe kullanılan modelleri de etkilemiştir. Röntgen görüntülerinde zatüreyi tanımaya çalışan bir modeliniz varken, bir gecede, anında yeni bir etiket (label) eklenmiştir.
